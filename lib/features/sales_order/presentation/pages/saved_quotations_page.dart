  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
          onPressed: () async {
              await Navigator.push(context, MaterialPageRoute(builder: (_) => const CreateQuotationPage()));
              _loadQuotations();
          },
                ...
                : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                      ...
                      return Card(
                          ...
                          child: ListTile(
                              title: Text('${quotation.customerName} - ${quotation.sn ?? "No SN"}'),
                              subtitle: Text(DateFormat('yyyy-MM-dd').format(quotation.date)),
                              trailing: Row(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                                      IconButton(
                                          icon: Icon(!kIsWeb && (Platform.isWindows || Platform.isMacOS || Platform.isLinux) 
                              ...
                              onTap: () async {
                                  await Navigator.push(
                                      context, 
                                      MaterialPageRoute(builder: (_) => CreateQuotationPage(existingQuotation: quotation))
                                  );
                                  _loadQuotations();
                              },
                          ),
